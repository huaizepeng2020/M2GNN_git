...
from utils.data_loader import load_data_both_amazon
from modules.base_model import M2GNN_word_amazon
...
if __name__ == '__main__':
    ...
    """build dataset"""
    train_cf, test_cf, user_dict, n_params, graph_tag = load_data_both_amazon(args)
    ...
    model = M2GNN_word_amazon(n_params, args).to(device)
